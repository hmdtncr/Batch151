...
public class Variables01 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //System.ou.println(), yazdırmanın kısayolu ==> sout yaz ve enter a bas
        ...
        //System.out.print(); ekrana yazdır ve printer i bir sonraki satıra kayar
        // print ise ekrana yazdırır ve painter i aynı tutar

        //double data type:
        // virgullu sayılar için kullanılır
        //memory de daha fazla yer kaplar, virgulden sonraki rakam daha fazla olur
        // ornek 9:
        double hucreAğırlığı = 0.000000001;
        double amipinAğırlığı = 0.0000000023;
        System.out.println(hucreAğırlığı - amipinAğırlığı);
    }
