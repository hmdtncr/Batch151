...
/*
   ArrayList'ler eleman ekleme ve silmede tekrar indexleme yapmak zorunda olduklarından eleman
    ekleme ve silmede başarısızdırlar.
    ...
    Bir eleman sildigimizde eleman sildik demiyoruz, node sildigimizi soyluyoruz.
      """"" data ve pointer bututnune "node" denir.""""""
 */
 /*
...
public class LinkedList01 {
    public static void main(String[] args) {
       ...
       // poll()//Ilk elemani size verir ve list'den siler (cut-paste)
