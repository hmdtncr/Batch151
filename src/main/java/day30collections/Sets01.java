...
public class Sets01 {
    ...
    2) 3 tane Set Class vardir;
      i) HashSet Class:
         "HashSet" Benzersiz id olusturma teknigidir, bu teknige "Hashing Technique" denir
 ...
 */
    public static void main(String[] args) {
        ...
        lhs.retainAll(ls);
        System.out.println(lhs); // [87, 124] ==> İlk LinkHasSet'teki farkli elemanlar silindi.Yani methodu cagirdigimiz elemanin farkli elemanlarini sildi.
        System.out.println(ls); //  [451, 87, 231, 124]
        ...
        System.out.println(ts.lower('R')); // G ==> Verilen eleman olan R'dn bir onceki elemanı verir.
        System.out.println(ts.lower('O'));
